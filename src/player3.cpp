...
Player3::Player3(QGraphicsItem *parent): QGraphicsPixmapItem(parent){
...
void Player3::keyPressEvent(QKeyEvent *event){
...
void Player3::move60_5(){
    ...
    for(int i=0,n=colliding.size();i<n;i++)
    {
        if (typeid(*colliding[i])==typeid(R1))
        {scene()->removeItem(this);
        r1->move();QGraphicsTextItem* abc=new QGraphicsTextItem;
        abc->setPlainText(QString("TRY AGAIN"));
        abc->setScale(4);
        abc->setPos(280,350);
        scene3->addItem(abc);
 ...
 if (typeid(*colliding[i])==typeid(R2))
                {scene()->removeItem(this);QGraphicsTextItem* abc=new QGraphicsTextItem;
     abc->setPlainText(QString("TRY AGAIN"));
     abc->setScale(4);
     abc->setPos(280,350);
     scene3->addItem(abc);}
                ...
                r9->move();
                QGraphicsTextItem* abc=new QGraphicsTextItem;
                 abc->setPlainText(QString("ANGRY BIRDS"
                                           " WINNER"));
                 abc->setScale(4);
                 abc->setPos(280,350);
                 scene3->addItem(abc);
                ...
                if (typeid(*colliding[i])==typeid(R7))
                {scene()->removeItem(this);
                r6->move();
                r6->setPos(790,590);
                r7->move();
